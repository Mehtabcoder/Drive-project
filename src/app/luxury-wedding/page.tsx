          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
              ...
              <p className="text-gray-700 text-lg leading-relaxed mb-8">
                Experience the epitome of luxury with our Audi A3 Cabriolet for your special day. This stunning convertible combines elegance, performance, and sophistication to make your wedding ceremony truly unforgettable.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800">Premium Decoration</h3>
                    <p className="text-sm text-gray-600">Elegant flower arrangements and ribbons</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800">Professional Chauffeur</h3>
                    <p className="text-sm text-gray-600">Experienced and well-dressed driver</p>
                  </div>
                </div>
