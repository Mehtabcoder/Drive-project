...
export default function LuxuryWedding() {
          ...
          <div className="space-y-8">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white p-4 rounded-2xl shadow-2xl">
                <Image
                  src="/cars/luxury-wedding/car1.png"
                  width={800}
                  height={500}
  ...
  <p className="mt-4 text-base leading-relaxed">
    Punjab Rent2GO offers a self-drive car that has never been easier! With affordable rates and flexible rental options, you can book the Thar for your next trip to Punjab or nearby cities like Himachal, Ladakh, and Spiti. So why wait? Book now and experience the ultimate comfort and performance of this amazing SUV!
  </p>

  <p className="mt-4 text-base leading-relaxed">
    If you're planning a trip and looking for a comfortable and stylish self-drive car, the Thar is a great option. You can rent this car at very reasonable rates from self-drive car rental services in Punjab and nearby cities, offering you a convenient and affordable way to explore your destination.
  </p>

  <h3 className="text-xl md:text-2xl font-semibold mt-8 mb-4 text-center">
    Key Specifications of Thar
  </h3>
  ...
  <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
    <div className="text-center mb-8">
      <h2 className="text-2xl font-bold text-gray-800 mb-2">Reserve Your Dream Car</h2>
