          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
              ...
              <p className="text-gray-700 text-lg leading-relaxed mb-8">
                Experience the epitome of luxury by booking a taxi from us for your special day. This stunning convertible combines elegance, performance, and sophistication to make your day truly unforgettable.
              </p>
